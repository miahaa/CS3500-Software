...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// </summary>
        /// <param name="start"> starting cell for the recursion.</param>
        /// <param name="name"> current cell being visited.</param>
        /// <param name="visited">A set of cells that have already been visited.</param>
        /// <param name="changed">A linked list representing the order of cell visited.</param>
        private void Visit(String start, String name, ISet<String> visited, LinkedList<String> changed)
        {
            // Mark the current cell as visited
            visited.Add(name);

            // Iterate each direct dependents of this current cell
            foreach (String n in GetDirectDependents(name))
            {
                // Check if it is circular or not
                if (n.Equals(start))
                {
                    // If true, throw CircularException
                    throw new CircularException();
                }
                // Recursively visit non-visited dependent cells
            ...
            // Add current cell to the begin of linkedlist
